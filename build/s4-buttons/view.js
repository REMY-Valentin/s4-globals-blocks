    ...
    $('.s4_block_carousel.owl-carousel').each(function () {
      ...
      const observer = new MutationObserver(function (mutations) {
        ...
        mutations.forEach(function (mutation) {
          if (mutation.type === 'attributes' && (mutation.attributeName === 'data-carousel-options' || mutation.attributeName === 'data-nav-style')) {
            needsReinit = true;
          }
        });
        if (needsReinit) {
      ...
      const config = {
        attributes: true,
        attributeFilter: ['data-carousel-options', 'data-nav-style']
      };
